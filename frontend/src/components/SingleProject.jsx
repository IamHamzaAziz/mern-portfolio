...
const SingleProject = ({ title, description, githubLink, className }) => {
  return (
    <div className={`h-[410px] sm:h-[470px] mx-2 w-60 sm:w-96 border-2 rounded-3xl hover:shadow-lg p-8 space-y-5 cursor-pointer flex flex-col justify-between ${className}`}>
