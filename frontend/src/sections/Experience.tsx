      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 space-y-10">
          {experiences.map((exp, index) => (
            <div
              key={index}
              className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-300 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-all duration-300"
            >
              <div className="p-6 sm:p-8">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div>
                    ...
                    <h4 className="text-lg sm:text-xl text-[#ec4e20] mt-1">
                      {exp.company}
                    </h4>
                  </div>
                  <div className="flex items-center text-sm sm:text-base text-gray-600 dark:text-gray-400 bg-gray-200/50 dark:bg-gray-700/50 px-3 py-1.5 rounded-full">
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-500 mt-2">- Helen Hayes</p>
          <p className="text-gray-700 dark:text-gray-300 font-bold mt-4 text-xl sm:text-2xl">
