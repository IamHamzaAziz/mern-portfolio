    ...
    return (
        <div className='py-20 section-border-bottom'>
            ...
            <form onSubmit={handleSubmit(submitForm)} className='w-3/4 mx-auto mt-12'>
                ...
                <button type={loading ? 'button' : 'submit'} className='mt-5 bg-[#ec4e20] text-gray-200 w-full px-6 py-2 rounded-lg flex items-center justify-center space-x-2 h-10 disabled:cursor-not-allowed' disabled={loading}>
                    {
                        loading ? (
                            <ThreeCircles
                                color='white'
